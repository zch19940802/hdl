...
ad_ip_parameter axi_hdmi_rx_dma CONFIG.CYCLIC 1
...
ad_ip_parameter axi_hdmi_rx_dma CONFIG.ENABLE_FRAME_LOCK 1
...
# change parameters of TX hdmi DMAc
ad_ip_parameter axi_hdmi_dma CONFIG.ENABLE_FRAME_LOCK 1

# link the two DMACs
ad_connect axi_hdmi_rx_dma/m_framelock axi_hdmi_dma/s_framelock
