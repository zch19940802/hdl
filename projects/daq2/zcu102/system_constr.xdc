...
set_property  -dict {PACKAGE_PIN  V3  IOSTANDARD LVCMOS18} [get_ports spi_dir]                              ; ## G13  FMC_HPC0_LA08_N

set_property  -dict {PACKAGE_PIN  V4  IOSTANDARD LVCMOS18} [get_ports clkd_sync]                            ; ## G12  FMC_HPC0_LA08_P
set_property  -dict {PACKAGE_PIN  W4  IOSTANDARD LVCMOS18} [get_ports dac_reset]                            ; ## C15  FMC_HPC0_LA10_N
...
set_property  -dict {PACKAGE_PIN  AB8 IOSTANDARD LVCMOS18} [get_ports clkd_status[0]]                       ; ## D17  FMC_HPC0_LA13_P
set_property  -dict {PACKAGE_PIN  AC8 IOSTANDARD LVCMOS18} [get_ports clkd_status[1]]                       ; ## D18  FMC_HPC0_LA13_N
...
## set_property  -dict {PACKAGE_PIN  L8} [get_ports rx_ref_clk_p]                                              ; ## B20  FMC_HPC0_GBTCLK1_M2C_P
## set_property  -dict {PACKAGE_PIN  L7} [get_ports rx_ref_clk_n]                                              ; ## B21  FMC_HPC0_GBTCLK1_M2C_N
## set_property  -dict {PACKAGE_PIN  G8} [get_ports tx_ref_clk_p]                                              ; ## D04  FMC_HPC0_GBTCLK0_M2C_P
## set_property  -dict {PACKAGE_PIN  G7} [get_ports tx_ref_clk_n]                                              ; ## D05  FMC_HPC0_GBTCLK0_M2C_N
...
set_property LOC GTHE4_CHANNEL_X1Y10 [get_cells -hierarchical -filter {NAME =~ *util_daq2_xcvr/inst/i_xch_1/i_gthe4_channel}]
set_property LOC GTHE4_CHANNEL_X1Y11 [get_cells -hierarchical -filter {NAME =~ *util_daq2_xcvr/inst/i_xch_2/i_gthe4_channel}]
